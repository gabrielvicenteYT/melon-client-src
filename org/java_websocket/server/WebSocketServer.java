...
public abstract class WebSocketServer extends AbstractWebSocket implements Runnable
{
    ...
    protected boolean removeConnection(final WebSocket ws) {
        ...
        synchronized (this.connections) {
            if (this.connections.contains(ws)) {
                ...
                this.log.trace("Removing connection which is not in the connections collection! Possible no handshake recieved! {}", ws);
            }
        }
    ...
    private void fillFrames(final Draft draft, final Map<Draft, List<Framedata>> draftFrames, final String sData, final ByteBuffer bData) {
