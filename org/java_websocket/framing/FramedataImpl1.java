...
public abstract class FramedataImpl1 implements Framedata
{
    ...
    public String toString() {
        return "Framedata{ optcode:" + this.getOpcode() + ", fin:" + this.isFin() + ", rsv1:" + this.isRSV1() + ", rsv2:" + this.isRSV2() + ", rsv3:" + this.isRSV3() + ", payloadlength:[pos:" + this.unmaskedpayload.position() + ", len:" + this.unmaskedpayload.remaining() + "], payload:" + ((this.unmaskedpayload.remaining() > 1000) ? "(too big to display)" : new String(this.unmaskedpayload.array())) + '}';
    }
