...
public class Image implements Renderable
{
    ...
    public Image getScaledCopy(final int width, final int height) {
        ...
        image2.textureOffsetX *= width / (float)this.width;
        final Image image3 = image;
        image3.textureOffsetY *= height / (float)this.height;
        final Image image4 = image;
        image4.textureWidth *= width / (float)this.width;
        final Image image5 = image;
        image5.textureHeight *= height / (float)this.height;
        return image;
    }
    ...
    public Color getColor(int x, int y) {
        ...
        x %= this.texture.getTextureWidth();
        y %= this.texture.getTextureHeight();
