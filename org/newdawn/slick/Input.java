...
public class Input
{
    ...
    public void removeKeyListener(final KeyListener listener) {
        ...
        this.keyListenersToAdd.remove(listener);
    ...
    public void removeMouseListener(final MouseListener listener) {
        ...
        this.mouseListenersToAdd.remove(listener);
    ...
    public int getAbsoluteMouseY() {
        return this.height - Mouse.getY() - 1;
    }
    
    public int getMouseX() {
        return (int)(this.getAbsoluteMouseX() * this.scaleX + this.xoffset);
    }
    
    public int getMouseY() {
        return (int)(this.getAbsoluteMouseY() * this.scaleY + this.yoffset);
    }
        ...
        while (Mouse.next()) {
            if (Mouse.getEventButton() >= 0) {
                if (Mouse.getEventButtonState()) {
                    ...
                    this.pressedY = (int)(this.yoffset + (height - Mouse.getEventY() - 1) * this.scaleY);
                    ...
                    final int releasedY = (int)(this.yoffset + (height - Mouse.getEventY() - 1) * this.scaleY);
