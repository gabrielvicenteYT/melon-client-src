...
public interface QueryBindings<T extends BindValue>
{
    ...
    void setTimestamp(final int p0, final Timestamp p1, final Calendar p2, final MysqlType p3);
    
    void setTimestamp(final int p0, final Timestamp p1, final MysqlType p2);
    
    void setTimestamp(final int p0, final Timestamp p1, final Calendar p2, final int p3, final MysqlType p4);
    
    void bindTimestamp(final int p0, final Timestamp p1, final Calendar p2, final int p3, final MysqlType p4);
    
    byte[] getBytesRepresentation(final int p0);
    
    byte[] getOrigBytes(final int p0);
    
    void setLocalDate(final int p0, final LocalDate p1, final MysqlType p2);
    
    void setLocalTime(final int p0, final LocalTime p1, final MysqlType p2);
    
    void setLocalDateTime(final int p0, final LocalDateTime p1, final MysqlType p2);
}
