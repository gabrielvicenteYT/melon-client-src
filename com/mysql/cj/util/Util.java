...
public class Util
{
    ...
    public static final int readBlock(final InputStream i, final byte[] b, final ExceptionInterceptor exceptionInterceptor) {
        try {
            return i.read(b);
        }
        catch (Throwable ex) {
    ...
    public static final int readBlock(final InputStream i, final byte[] b, final int length, final ExceptionInterceptor exceptionInterceptor) {
        try {
