...
public class StringUtils
{
    ...
    public static boolean endsWithIgnoreCase(final String searchIn, final String searchFor) {
    ...
    public static List<String> splitDBdotName(final String source, final String db, final String quoteId, final boolean isNoBslashEscSet) {
    ...
    public static String getFullyQualifiedName(final String db, final String entity, final String quoteId, final boolean isPedantic) {
        final StringBuilder fullyQualifiedName = new StringBuilder(quoteIdentifier((db == null) ? "" : db, quoteId, isPedantic));
    ...
    public static byte[] unquoteBytes(final byte[] bytes) {
        if (bytes[0] == 39 && bytes[bytes.length - 1] == 39) {
            final byte[] valNoQuotes = new byte[bytes.length - 2];
            int j = 0;
            int quoteCnt = 0;
    ...
    public static byte[] quoteBytes(final byte[] bytes) {
        final byte[] withQuotes = new byte[bytes.length * 2 + 2];
        int j = 0;
        withQuotes[j++] = 39;
