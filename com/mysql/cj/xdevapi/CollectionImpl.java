...
public class CollectionImpl implements Collection
{
    ...
    public Result createIndex(final String indexName, final DbDoc indexDefinition) {
        return this.mysqlxSession.query(this.xbuilder.buildCreateCollectionIndex(this.schema.getName(), this.name, new CreateIndexParams(indexName, indexDefinition)), new UpdateResultBuilder<Result>());
    }
    
    @Override
    public Result createIndex(final String indexName, final String jsonIndexDefinition) {
        return this.mysqlxSession.query(this.xbuilder.buildCreateCollectionIndex(this.schema.getName(), this.name, new CreateIndexParams(indexName, jsonIndexDefinition)), new UpdateResultBuilder<Result>());
    }
    
    @Override
    public void dropIndex(final String indexName) {
        try {
            this.mysqlxSession.query(this.xbuilder.buildDropCollectionIndex(this.schema.getName(), this.name, indexName), new UpdateResultBuilder<QueryResult>());
        }
