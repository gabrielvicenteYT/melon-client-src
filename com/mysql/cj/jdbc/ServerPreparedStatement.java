...
public class ServerPreparedStatement extends ClientPreparedStatement
{
    ...
    protected static ServerPreparedStatement getInstance(final JdbcConnection conn, final String sql, final String db, final int resultSetType, final int resultSetConcurrency) throws SQLException {
        return new ServerPreparedStatement(conn, sql, db, resultSetType, resultSetConcurrency);
    }
    
    protected ServerPreparedStatement(final JdbcConnection conn, final String sql, final String db, final int resultSetType, final int resultSetConcurrency) throws SQLException {
        super(conn, db);
