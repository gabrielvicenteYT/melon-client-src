...
public class CallableStatement extends ClientPreparedStatement implements java.sql.CallableStatement
{
    ...
    protected static CallableStatement getInstance(final JdbcConnection conn, final String sql, final String db, final boolean isFunctionCall) throws SQLException {
    ...
    public CallableStatement(final JdbcConnection conn, final String sql, final String db, final boolean isFunctionCall) throws SQLException {
        super(conn, sql, db);
        this.callingStoredFunction = false;
        this.hasOutputParams = false;
        this.outputParamWasNull = false;
                        ...
                        if (inParamInfo.isOut && inParamInfo.isIn) {
                            ...
                            try {
                                ...
                                if (((PreparedQuery)this.query).getQueryBindings().getBindValues()[inParamInfo.index].isNull()) {
                                    ...
                                    final byte[] parameterAsBytes = this.getBytesRepresentation(inParamInfo.index + 1);
