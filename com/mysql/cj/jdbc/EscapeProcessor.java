...
class EscapeProcessor
{
    ...
    public static final Object escapeSQL(final String sql, final TimeZone connectionTimeZone, final boolean serverSupportsFractionalSecond, final boolean serverTruncatesFractionalSecond, final ExceptionInterceptor exceptionInterceptor) throws SQLException {
                ...
                if (token.charAt(0) == '{') {
                    ...
                    if (token.length() > 2) {
                        ...
                        if (nestedBrace != -1) {
                            ...
                            final Object remainingResults = escapeSQL(token.substring(1, token.length() - 1), connectionTimeZone, serverSupportsFractionalSecond, serverTruncatesFractionalSecond, exceptionInterceptor);
    ...
    private static void processTimestampToken(final TimeZone tz, final StringBuilder newSql, final String token, final boolean serverSupportsFractionalSecond, final boolean serverTruncatesFractionalSecond, final ExceptionInterceptor exceptionInterceptor) throws SQLException {
        ...
        if (startPos == -1 || endPos == -1) {
            ...
            try {
                ...
                final SimpleDateFormat tsdf = TimeUtil.getSimpleDateFormat(null, "''yyyy-MM-dd HH:mm:ss", tz);
