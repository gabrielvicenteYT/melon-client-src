...
public class StatementImpl implements JdbcStatement
{
    ...
    public StatementImpl(final JdbcConnection c, final String db) throws SQLException {
            ...
            synchronized (locallyScopedConn.getConnectionMutex()) {
                ...
                try {
                    ...
                    if (this.doEscapeProcessing) {
                        final Object escapedSqlResult = EscapeProcessor.escapeSQL(sql, this.session.getServerSession().getSessionTimeZone(), this.session.getServerSession().getCapabilities().serverSupportsFracSecs(), this.session.getServerSession().isServerTruncatesFracSecs(), this.getExceptionInterceptor());
                    ...
                    if (this.useServerFetch()) {
                        ...
                        try {
                            ...
                            this.statementBegins();
                            rs = ((NativeSession)locallyScopedConn.getSession()).execSQL(this, sql, this.maxRows, null, this.createStreamingResultSet(), this.getResultSetFactory(), cachedMetaData, false);
                            if (timeoutTask != null) {
        ...
        try {
            synchronized (this.checkClosed().getConnectionMutex()) {
                ...
                try {
                    ...
                    this.statementBegins();
                    this.results = ((NativeSession)locallyScopedConn.getSession()).execSQL(this, sql, this.maxRows, null, this.createStreamingResultSet(), this.getResultSetFactory(), cachedMetaData, false);
                    if (timeoutTask != null) {
                        this.stopQueryTimer(timeoutTask, true, true);
                        timeoutTask = null;
                    }
