...
public class DatabaseMetaData implements java.sql.DatabaseMetaData
{
    ...
    protected void convertToJdbcFunctionList(final ResultSet proceduresRs, final List<ComparableWrapper<String, Row>> procedureRows, final Field[] fields) throws SQLException {
        while (proceduresRs.next()) {
            final String procDb = proceduresRs.getString("db");
            final String functionName = proceduresRs.getString("name");
            byte[][] rowData = null;
            ...
            procedureRows.add(new ComparableWrapper<String, Row>(StringUtils.getFullyQualifiedName(procDb, functionName, this.quotedId, this.pedantic), new ByteArrayRow(rowData, this.getExceptionInterceptor())));
        }
    }
    
    protected void convertToJdbcProcedureList(final boolean fromSelect, final ResultSet proceduresRs, final List<ComparableWrapper<String, Row>> procedureRows) throws SQLException {
        while (proceduresRs.next()) {
            final String procDb = proceduresRs.getString("db");
            final String procedureName = proceduresRs.getString("name");
            final byte[][] rowData = { (this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? this.s2b("def") : this.s2b(procDb), (this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? this.s2b(procDb) : null, this.s2b(procedureName), null, null, null, this.s2b(proceduresRs.getString("comment")), null, null };
            ...
            procedureRows.add(new ComparableWrapper<String, Row>(StringUtils.getFullyQualifiedName(procDb, procedureName, this.quotedId, this.pedantic), new ByteArrayRow(rowData, this.getExceptionInterceptor())));
        }
    }
    ...
    private Row convertTypeDescriptorToProcedureRow(final byte[] procNameAsBytes, final byte[] procCatAsBytes, final String paramName, final boolean isOutParam, final boolean isInParam, final boolean isReturnParam, final TypeDescriptor typeDesc, final boolean forGetFunctionColumns, final int ordinal) throws SQLException {
        ...
        row[8] = (byte[])((typeDesc.columnSize == null) ? null : this.s2b(typeDesc.columnSize.toString()));
    ...
    public List<Row> extractForeignKeyForTable(final ArrayList<Row> rows, final ResultSet rs, final String dbName) throws SQLException {
                ...
                if (indexOfFK != -1) {
                    ...
                    if (indexOfRef != -1) {
                        ...
                        if (referencedColumnBegin != -1) {
                            ...
                            final int indexOfDbSep = StringUtils.indexOfIgnoreCase(0, referencedTableName, ".", this.quotedId, this.quotedId, StringUtils.SEARCH_MODE__ALL);
                            if (indexOfDbSep != -1) {
    ...
    public ResultSet extractForeignKeyFromCreateTable(final String dbName, final String tableName) throws SQLException {
        ...
        if (tableName != null) {
            ...
            try {
                rs = ((this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? this.getTables(null, dbName, null, new String[] { "TABLE" }) : this.getTables(dbName, null, null, new String[] { "TABLE" }));
                while (rs.next()) {
        ...
        try {
            for (int i = 0; i < numTables; ++i) {
                ...
                final String query = "SHOW CREATE TABLE " + StringUtils.getFullyQualifiedName(dbName, tableToExtract, this.quotedId, this.pedantic);
                try {
                    rs = stmt.executeQuery(query);
                }
                catch (SQLException sqlEx) {
                    final String sqlState = sqlEx.getSQLState();
                    if (!"42S02".equals(sqlState) && sqlEx.getErrorCode() != 1146 && sqlEx.getErrorCode() != 1049) {
                        throw sqlEx;
                    }
                    continue;
                }
    ...
    public ResultSet getBestRowIdentifier(final String catalog, final String schema, final String table, final int scope, final boolean nullable) throws SQLException {
        try {
            ...
            final String db = this.getDatabase(catalog, schema);
            try {
                new IterateBlock<String>(this.getDatabaseIterator(db)) {
                    @Override
                    void forEach(final String dbStr) throws SQLException {
                        ...
                        try {
                            ...
                            if (!"42S02".equals(sqlEx2.getSQLState())) {
                                throw sqlEx2;
                            }
                        }
                        finally {
    ...
    private void getCallStmtParameterTypes(String db, String quotedProcName, final ProcedureType procType, final String parameterNamePattern, final List<Row> resultRows, final boolean forGetFunctionColumns) throws SQLException {
        ...
        try {
            ...
            final String oldDb = this.conn.getDatabase();
            ...
            final int dotIndex = " ".equals(this.quotedId) ? quotedProcName.indexOf(".") : StringUtils.indexOfIgnoreCase(0, quotedProcName, ".", this.quotedId, this.quotedId, this.session.getServerSession().isNoBackslashEscapesSet() ? StringUtils.SEARCH_MODE__MRK_COM_WS : StringUtils.SEARCH_MODE__ALL);
            String dbName = null;
    ...
    protected IteratorWithCleanup<String> getDatabaseIterator(final String dbSpec) throws SQLException {
        if (dbSpec == null) {
            return ((boolean)this.nullDatabaseMeansCurrent.getValue()) ? new SingleStringIterator(this.database) : new StringListIterator(this.getDatabases());
        }
        return new SingleStringIterator(this.pedantic ? dbSpec : StringUtils.unQuoteIdentifier(dbSpec, this.quotedId));
    }
    
    protected IteratorWithCleanup<String> getSchemaPatternIterator(final String schemaPattern) throws SQLException {
    ...
    protected List<String> getDatabases(final String dbPattern) throws SQLException {
        PreparedStatement pStmt = null;
        ResultSet results = null;
        Statement stmt = null;
        try {
            stmt = this.conn.getMetadataSafeStatement();
            final StringBuilder queryBuf = new StringBuilder("SHOW DATABASES");
            if (dbPattern != null) {
            ...
            final List<String> resultsAsList = new ArrayList<String>(dbCount);
            while (results.next()) {
    ...
    public ResultSet getCatalogs() throws SQLException {
        try {
            final List<String> resultsAsList = (this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? new ArrayList<String>() : this.getDatabases();
            final Field[] fields = { new Field("", "TABLE_CAT", this.metadataCollationIndex, this.metadataEncoding, MysqlType.VARCHAR, 0) };
            final ArrayList<Row> tuples = new ArrayList<Row>(resultsAsList.size());
    ...
    protected String getDatabase(final String catalog, final String schema) {
    ...
    public ResultSet getColumns(final String catalog, final String schemaPattern, final String tableNamePattern, final String columnNamePattern) throws SQLException {
        try {
            final String db = this.getDatabase(catalog, schemaPattern);
                        ...
                        for (final String tableName : tableNameList) {
                            ...
                            try {
                                ...
                                while (results.next()) {
                                    ...
                                    rowVal[1] = (byte[])((DatabaseMetaData.this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? DatabaseMetaData.this.s2b(dbStr) : null);
    ...
    public ResultSet getCrossReference(final String primaryCatalog, final String primarySchema, final String primaryTable, final String foreignCatalog, final String foreignSchema, final String foreignTable) throws SQLException {
        try {
            ...
            final String foreignDb = this.getDatabase(foreignCatalog, foreignSchema);
                                ...
                                if (tableType != null && (tableType.equalsIgnoreCase("innodb") || tableType.equalsIgnoreCase("SUPPORTS_FK"))) {
                                    ...
                                    while (commentTokens.hasMoreTokens()) {
                                        ...
                                        while (referencingColumns.hasNext()) {
                                            ...
                                            final byte[][] tuple = { dbMapsToSchema ? DatabaseMetaData.this.s2b("def") : DatabaseMetaData.this.s2b(parsedInfo.referencedDatabase), dbMapsToSchema ? DatabaseMetaData.this.s2b(parsedInfo.referencedDatabase) : null, DatabaseMetaData.this.s2b(parsedInfo.referencedTable), DatabaseMetaData.this.s2b(StringUtils.unQuoteIdentifier(referencedColumns.next(), DatabaseMetaData.this.quotedId)), dbMapsToSchema ? DatabaseMetaData.this.s2b("def") : DatabaseMetaData.this.s2b(dbStr), dbMapsToSchema ? DatabaseMetaData.this.s2b(dbStr) : null, DatabaseMetaData.this.s2b(dummy), DatabaseMetaData.this.s2b(referencingColumn), Integer.toString(keySeq).getBytes(), null, null, null, null, null };
    ...
    public String getDriverVersion() throws SQLException {
        try {
            return "mysql-connector-java-8.0.23 (Revision: 18bbd5e68195d0da083cbd5bd0d05d76320df7cd)";
        }
        catch (CJException ex) {
            throw SQLExceptionsMapping.translateException(ex, this.getExceptionInterceptor());
        }
                        ...
                        try {
                            ...
                            while (fkresults.next()) {
                                ...
                                if (tableType != null && (tableType.equalsIgnoreCase("innodb") || tableType.equalsIgnoreCase("SUPPORTS_FK"))) {
                                    ...
                                    commentTokens.nextToken();
                                    while (commentTokens.hasMoreTokens()) {
                                        final String keysComment = commentTokens.nextToken();
                    ...
                    void forEach(final String dbStr) throws SQLException {
                        ...
                        try {
                            ...
                            while (results != null && results.next()) {
                                ...
                                row[1] = (byte[])(dbMapsToSchema ? DatabaseMetaData.this.s2b(dbStr) : null);
    ...
    public ResultSet getPrimaryKeys(final String catalog, final String schema, final String table) throws SQLException {
        try {
                        ...
                        try {
                            ...
                            while (rs != null && rs.next()) {
                                ...
                                if (keyType != null && (keyType.equalsIgnoreCase("PRIMARY") || keyType.equalsIgnoreCase("PRI"))) {
                                    final byte[][] tuple = { dbMapsToSchema ? DatabaseMetaData.this.s2b("def") : DatabaseMetaData.this.s2b(dbStr), dbMapsToSchema ? DatabaseMetaData.this.s2b(dbStr) : null, DatabaseMetaData.this.s2b(table), null, null, null };
            ...
            final ResultSet results = this.resultSetFactory.createFromResultsetRows(1007, 1004, new ResultsetRowsStatic(rows, new DefaultColumnDefinition(this.getPrimaryKeysFields())));
            return results;
        }
        catch (CJException ex) {
            throw SQLExceptionsMapping.translateException(ex, this.getExceptionInterceptor());
    ...
    protected ResultSet getProcedureOrFunctionColumns(final Field[] fields, final String catalog, final String schemaPattern, final String procedureOrFunctionNamePattern, final String columnNamePattern, final boolean returnProcedures, final boolean returnFunctions) throws SQLException {
        ...
        try {
            ...
            if (tmpProcedureOrFunctionNamePattern == null) {
                ...
                String tmpDb = db;
                final List<String> parseList = StringUtils.splitDBdotName(tmpProcedureOrFunctionNamePattern, tmpDb, this.quotedId, this.session.getServerSession().isNoBackslashEscapesSet());
                if (parseList.size() == 2) {
    ...
    void populateKeyResults(final String db, final String table, final String keysComment, final List<Row> resultRows, final String fkTableName, final boolean isExport) throws SQLException {
        ...
        while (localColumnNames.hasNext()) {
            ...
            tuple[1] = (byte[])(dbMapsToSchema ? this.s2b(parsedInfo.referencedDatabase) : null);
            ...
            tuple[5] = (byte[])(dbMapsToSchema ? this.s2b(db) : null);
    ...
    public ResultSet getSchemas(final String catalog, final String schemaPattern) throws SQLException {
        try {
            final List<String> dbList = (this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? this.getDatabases(schemaPattern) : new ArrayList<String>();
            ...
            final ArrayList<Row> tuples = new ArrayList<Row>(dbList.size());
            for (final String db : dbList) {
                final byte[][] rowVal = { this.s2b(db), this.s2b("def") };
                tuples.add(new ByteArrayRow(rowVal, this.getExceptionInterceptor()));
            }
            return this.resultSetFactory.createFromResultsetRows(1007, 1004, new ResultsetRowsStatic(tuples, new DefaultColumnDefinition(fields)));
        }
    ...
    public ResultSet getTablePrivileges(final String catalog, final String schemaPattern, final String tableNamePattern) throws SQLException {
        try {
            ...
            final String dbPattern = this.getDatabase(catalog, schemaPattern);
                        ...
                        while (st.hasMoreTokens()) {
                            ...
                            try {
                                ...
                                while (columnResults.next()) {
                                    final byte[][] tuple = { (this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? this.s2b("def") : this.s2b(db), (this.databaseTerm.getValue() == PropertyDefinitions.DatabaseTerm.SCHEMA) ? this.s2b(db) : null, this.s2b(table), (grantor != null) ? this.s2b(grantor) : null, this.s2b(fullUser.toString()), this.s2b(privilege), null, null };
                                    grantRows.add(new ByteArrayRow(tuple, this.getExceptionInterceptor()));
                                }
                            }
                            finally {
    ...
    public ResultSet getTables(final String catalog, final String schemaPattern, String tableNamePattern, final String[] types) throws SQLException {
        try {
            ...
            try {
                new IterateBlock<String>(dbMapsToSchema ? this.getSchemaPatternIterator(db) : this.getDatabaseIterator(db)) {
                    @Override
                    void forEach(final String dbPattern) throws SQLException {
                        final boolean operatingOnSystemDB = "information_schema".equalsIgnoreCase(dbPattern) || "mysql".equalsIgnoreCase(dbPattern) || "performance_schema".equalsIgnoreCase(dbPattern);
                        ResultSet results = null;
                        try {
                            try {
                            ...
                            while (results.next()) {
                                final byte[][] row = { dbMapsToSchema ? DatabaseMetaData.this.s2b("def") : DatabaseMetaData.this.s2b(dbPattern), dbMapsToSchema ? DatabaseMetaData.this.s2b(dbPattern) : null, results.getBytes(1), null, new byte[0], null, null, null, null, null };
                                if (hasTableTypes) {
    ...
    protected LocalAndReferencedColumns parseTableStatusIntoLocalAndReferencedColumns(String keysComment) throws SQLException {
        ...
        final String referDbTableString = keysCommentTrimmed.substring(indexOfRefer + "REFER ".length(), indexOfOpenParenReferCol);
        final int indexOfSlash = StringUtils.indexOfIgnoreCase(0, referDbTableString, "/", this.quotedId, this.quotedId, StringUtils.SEARCH_MODE__MRK_COM_WS);
        if (indexOfSlash == -1) {
            throw SQLError.createSQLException(Messages.getString("DatabaseMetaData.18"), "S1000", this.getExceptionInterceptor());
        }
        final String referDb = StringUtils.unQuoteIdentifier(referDbTableString.substring(0, indexOfSlash), this.quotedId);
        final String referTable = StringUtils.unQuoteIdentifier(referDbTableString.substring(indexOfSlash + 1).trim(), this.quotedId);
    ...
    protected PreparedStatement prepareMetaDataSafeStatement(final String sql) throws SQLException {
        final PreparedStatement pStmt = this.conn.clientPrepareStatement(sql, 1004, 1007);
    ...
    class LocalAndReferencedColumns
    {
        ...
        LocalAndReferencedColumns(final List<String> localColumns, final List<String> refColumns, final String constName, final String refDatabase, final String refTable) {
    ...
    protected class StringListIterator extends IteratorWithCleanup<String>
    {
        ...
        StringListIterator(final List<String> list) {
            this.idx = -1;
            this.list = list;
        }
        ...
        TypeDescriptor(final String typeInfo, final String nullabilityInfo) throws SQLException {
            ...
            switch (this.mysqlType) {
                ...
                case FLOAT_UNSIGNED: {
                    ...
                    if (typeInfo.indexOf("(") != -1) {
                        final int size = Integer.valueOf(typeInfo.substring(typeInfo.indexOf("(") + 1, typeInfo.indexOf(")")).trim());
                        if (size > 23) {
