...
final class BooleanArrayList extends AbstractProtobufList<Boolean> implements Internal.BooleanList, RandomAccess, PrimitiveNonBoxingCollection
{
    ...
    private BooleanArrayList(final boolean[] other, final int size) {
        this.array = other;
        this.size = size;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final BooleanArrayList other = (BooleanArrayList)o;
    ...
    @Override
    public Internal.BooleanList mutableCopyWithCapacity(final int capacity) {
    ...
    @Override
    public boolean setBoolean(final int index, final boolean element) {
        this.ensureIsMutable();
        this.ensureIndexInRange(index);
        final boolean previousValue = this.array[index];
    ...
    private void addBoolean(final int index, final boolean element) {
        this.ensureIsMutable();
    ...
    public Boolean remove(final int index) {
        this.ensureIsMutable();
        this.ensureIndexInRange(index);
        final boolean value = this.array[index];
    ...
    static {
        (EMPTY_LIST = new BooleanArrayList(new boolean[0], 0)).makeImmutable();
    }
}
