...
public final class WireFormat
{
    ...
    static Object readPrimitiveField(final CodedInputStream input, final FieldType type, final Utf8Validation utf8Validation) throws IOException {
        switch (type) {
            case DOUBLE: {
    ...
    enum Utf8Validation
    {
        LOOSE {
            @Override
            Object readString(final CodedInputStream input) throws IOException {
        ...
        abstract Object readString(final CodedInputStream p0) throws IOException;
    }
}
