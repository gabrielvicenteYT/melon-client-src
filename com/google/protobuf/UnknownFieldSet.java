...
public final class UnknownFieldSet implements MessageLite
{
    ...
    void writeTo(final Writer writer) throws IOException {
        if (writer.fieldOrder() == Writer.FieldOrder.DESCENDING) {
            for (final Map.Entry<Integer, Field> entry : this.fieldsDescending.entrySet()) {
    ...
    public static final class Builder implements MessageLite.Builder
    {
        ...
        public UnknownFieldSet build() {
            ...
            if (this.fields.isEmpty()) {
                ...
                descendingFields = Collections.unmodifiableMap((Map<? extends Integer, ? extends Field>)((TreeMap)this.fields).descendingMap());
                result = new UnknownFieldSet(Collections.unmodifiableMap((Map<? extends Integer, ? extends Field>)this.fields), descendingFields);
            }
            this.fields = null;
            return result;
        }
    ...
    public static final class Field
    {
        ...
        private void writeAsMessageSetExtensionTo(final int fieldNumber, final Writer writer) throws IOException {
            if (writer.fieldOrder() == Writer.FieldOrder.DESCENDING) {
                final ListIterator<ByteString> iter = this.lengthDelimited.listIterator(this.lengthDelimited.size());
