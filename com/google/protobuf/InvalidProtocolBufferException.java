...
public class InvalidProtocolBufferException extends IOException
{
    ...
    public InvalidProtocolBufferException(final IOException e) {
        super(e.getMessage(), e);
        this.unfinishedMessage = null;
    }
    
    public InvalidProtocolBufferException(final String description, final IOException e) {
        super(description, e);
        this.unfinishedMessage = null;
    }
    ...
    public static class InvalidWireTypeException extends InvalidProtocolBufferException
    {
        ...
        public InvalidWireTypeException(final String description) {
            super(description);
        }
    }
}
