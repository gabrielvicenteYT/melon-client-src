...
public final class WrappersProto
{
    ...
    public static Descriptors.FileDescriptor getDescriptor() {
        return WrappersProto.descriptor;
    }
    ...
    static {
        ...
        WrappersProto.descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[0]);
        internal_static_google_protobuf_DoubleValue_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_google_protobuf_DoubleValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_DoubleValue_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_FloatValue_descriptor = getDescriptor().getMessageTypes().get(1);
        internal_static_google_protobuf_FloatValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_FloatValue_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_Int64Value_descriptor = getDescriptor().getMessageTypes().get(2);
        internal_static_google_protobuf_Int64Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_Int64Value_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_UInt64Value_descriptor = getDescriptor().getMessageTypes().get(3);
        internal_static_google_protobuf_UInt64Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_UInt64Value_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_Int32Value_descriptor = getDescriptor().getMessageTypes().get(4);
        internal_static_google_protobuf_Int32Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_Int32Value_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_UInt32Value_descriptor = getDescriptor().getMessageTypes().get(5);
        internal_static_google_protobuf_UInt32Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_UInt32Value_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_BoolValue_descriptor = getDescriptor().getMessageTypes().get(6);
        internal_static_google_protobuf_BoolValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_BoolValue_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_StringValue_descriptor = getDescriptor().getMessageTypes().get(7);
        internal_static_google_protobuf_StringValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_StringValue_descriptor, new String[] { "Value" });
        internal_static_google_protobuf_BytesValue_descriptor = getDescriptor().getMessageTypes().get(8);
        internal_static_google_protobuf_BytesValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WrappersProto.internal_static_google_protobuf_BytesValue_descriptor, new String[] { "Value" });
    }
}
