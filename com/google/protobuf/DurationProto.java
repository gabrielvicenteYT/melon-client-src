...
public final class DurationProto
{
    ...
    static {
        ...
        DurationProto.descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[0]);
        internal_static_google_protobuf_Duration_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_google_protobuf_Duration_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(DurationProto.internal_static_google_protobuf_Duration_descriptor, new String[] { "Seconds", "Nanos" });
    }
}
